...
use App\Models\dompdf\src\Css\Style;
use App\Models\dompdf\src\Dompdf;
use App\Models\dompdf\src\Exception;
use App\Models\dompdf\src\Frame;
use App\Models\dompdf\src\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use App\Models\dompdf\src\FrameDecorator\Page as PageFrameDecorator;
use App\Models\dompdf\src\FrameReflower\Page as PageFrameReflower;
use App\Models\dompdf\src\Positioner\AbstractPositioner;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "App\\Models\\dompdf\\src\\FrameDecorator\\$decorator";
        $reflower   = "App\\Models\\dompdf\\src\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\App\\Models\\dompdf\\src\\Positioner\\'.$type;
