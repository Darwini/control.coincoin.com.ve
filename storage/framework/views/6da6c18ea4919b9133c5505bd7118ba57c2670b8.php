    <?php if(Session::has('message-danger') ): ?>
      <div class="container-fluid" >
        <div class="darwin-panel">
          ...
          <b><?php echo e(Session::get('message-danger')); ?></b>
        </div>
      </div>
      <style>
        .darwin-panel { 
    ...
    <?php if(Session::has('message-info')): ?>
      <div class="container-fluid" >
        <div class="darwin-panel">
          ...
          <span><?php echo e(Session::get('message-info')); ?>  </span>
        </div>
      </div>
    ...
    <?php if(Session::has('message-warning')): ?>
      <div class="container-fluid" >
        <div class="darwin-panel">
          <span style="float: right; padding-right: 16px;" class="w3-text-black w3-hover-text-red" onclick="$(this).parent().remove()">&times;</span>
          <span> <b> <strong>ATENCIÓN!</strong> </b><?php echo e(Session::get('message-warning')); ?></span>
        </div>
      </div>
