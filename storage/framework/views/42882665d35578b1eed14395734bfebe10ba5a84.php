<?php $__env->startSection('title', 'CoinCoin | Inicio'); ?>

<?php echo $__env->make('installers.install.modal_alert', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('status_miners'); ?>
  <span class="w3-text-yellow" id="amarillo"></span>
  <div class="col-md-6 dropdown dropleft w3-ripple" style="display: inline;">
    <img class="w3-round dropdown-toggle waves-effect" data-toggle="dropdown" style="width: 35px; display: inline;" src="<?php echo e(asset('assets/images/minero_bajo_rendimiento.gif')); ?>">
  ...
  <div class="col-md-6 dropdown dropright w3-ripple" style="display: inline;">
    <img class="w3-round dropdown-toggle" data-toggle="dropdown" style="width: 35px; display: inline;" src="<?php echo e(asset('assets/images/minero_dañado.png')); ?>">
...
<?php $__env->startSection('content'); ?>
  <div class="w3-hide" style="overflow: hidden;">
    <img id="mineroactivo" class="<?php echo e(asset('assets/images/minero_100_operativo.gif')); ?>">
    <img id="minerodañado" class="<?php echo e(asset('assets/images/minero_dañado.png')); ?>">
    <img id="minerobajo" class="<?php echo e(asset('assets/images/minero_bajo_rendimiento.gif')); ?>">
  ...
  <?php $__currentLoopData = $ubicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubicados): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('installers.install.modal_detalle', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="w3-text-black w3-panel w3-center w3-large" id="vacio"></div>
          ...
          <?php if(isset($salas) && count($salas)>0): ?>
            <?php $__currentLoopData = $salas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sala): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="" id="Sala<?php echo e($sala->id); ?>">
                        ...
                        <table class="w3-table w3-centered w3-tiny" border="1" style="margin: 10px 0px 10px 0px; border: 1px solid;">
                          <thead>
                            <tr class="w3-orange" style="color: #fff;">
                              <th class="w3-xlarge font-bold" colspan="<?php echo e($rack->columnas); ?>">
                            ...
                            <?php for($i=0; $i < $rack->filas; $i++): ?>
                              <tr id="rack<?php echo e($rack->id); ?>">
                                <?php for($j=0; $j < $rack->columnas; $j++): ?>
                                  <td id="posicion<?php echo e($k); ?>" class="w3-card w3-btn">
                                    <img src="<?php echo e(asset('assets/images/minero_disponible.png')); ?>" style="width: 32px;" class="w3-round"> &nbsp; <?php echo e($k++); ?>
  ...
  <ul style="list-style-type: none;display: none;">
    <?php $__currentLoopData = $ubicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubicados): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li id="<?php echo e($ubicados->minero_id); ?>" class="<?php echo e($ubicados->rack->rack); ?>" posicion="Posición : <?php echo e($ubicados->posicion); ?>" minero="<?php echo e($ubicados->minero_id); ?>" rackid="<?php echo e($ubicados->rack_id); ?>"></li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </ul>
<?php $__env->stopSection(); ?>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      <?php foreach($ubicaciones as $ubicados) { ?>
        ubicaciones('<?php echo e($ubicados->rack_id); ?>', '<?php echo e($ubicados->posicion); ?>', '<?php echo e($ubicados->userclient->username); ?>', '<?php echo e($ubicados->modelo); ?>', '<?php echo e($ubicados->minero_id); ?>', '<?php echo e($ubicados->minero_nombre); ?>', '<?php echo e($ubicados->serial_fuente); ?>', '<?php echo e($ubicados->serial_equipo); ?>', '<?php echo e($ubicados->rack->rack); ?>');
      <?php } ?>
    });
    ...
    function alert_show(id){
      ...
      url = $("#url").attr('value');
      route = url+"/Alerts/"+id;
      xhr = $.get(route, { _token : '<?php echo e(csrf_token()); ?>', id : id });
