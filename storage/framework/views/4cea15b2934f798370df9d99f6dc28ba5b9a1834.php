<?php $__env->startSection('title', 'CoinCoin | Detalles Usuarios/Equipos'); ?>
  ...
  <link href="<?php echo e(asset('assets/plugins/footable/css/footable.core.css')); ?>">
	...
	<script type="text/javascript">
      ...
      $.get( yuri, function(datos){
		...
		mismineros('<?php echo e($user[0]->puid); ?>');
			...
			<div class="card">
				<div class="card-body">
					<center class="w3-xlarge w3-text-orange">
						...
						<span class="w3-text-black"> : <?php echo e($user[0]->username); ?></span>
					</center>
                ...
                <img style="width: 30px;margin-top: 8px;border-radius: 10%;" src="<?php echo e(asset('assets/images/minero_100_operativo.png')); ?>"><br><br>
                  ...
                  Total:<span class="w3-large" id="all"></span>
						...
						<div style="margin: 60px 4% 50px 4%;" class="col-md-3 pull-left w3-border w3-border-orange w3-center w3-card-2">
							Alertas<br>
							<span class="w3-half">
								<img style="width:55px; margin: 10px 0px 20px 0px;" class="w3-round" src="<?php echo e(asset('assets/images/minero_dañado.png')); ?>"> &nbsp;
								<span class="w3-large w3-text-red" id="red"></span>
							</span>
							

							<span class="w3-half">
								<img style="width:55px; margin: 10px 2px 20px 2px;" class="w3-round" src="<?php echo e(asset('assets/images/minero_bajo_rendimiento.gif')); ?>"> &nbsp;
