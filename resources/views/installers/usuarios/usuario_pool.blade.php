    ...
    <div class="modal fade" id="modal_usuario_pool" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content w3-small" style="border:solid 1px orange;">
                ...
                <form method="post" action="{{route('usuario.cliente')}}">
                    {{csrf_field()}}
                    <div class="modal-body w3-small">
                        ...
                        {{--<div class="form-group w3-half" style="visibility: hidden;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {{--<input type="text" placeholder="POOL" class="form-control form-control-sm" value="{{old('pool')}}" style="text-transform: uppercase;">--}}
                                <div class="input-group-addon w3-text-orange">
