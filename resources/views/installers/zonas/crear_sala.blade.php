...
<div class="modal fade" id="modalsala" role="dialog">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content" style="border: 1px solid orange">
      ...
      <form method="POST" action="{{route('crear.sala')}}">
        {{csrf_field()}}
        <div class="modal-body">
          <label class="form-group" style="width: 100%;"> Nombre de la Sala :<br>
            <input autocomplete="off" type="text" required="required" name="sala" class="form-control w3-input form-control-sm" placeholder="Nombre de Referencia" value="{{old('sala')}}">
          </label><br>
                                    
          <label class="form-group" style="width: 100%;"> Descripción : <br>
            <input class="w3-input form-control-sm form-control" autocomplete="off" type="text" name="descripcion" placeholder="Punto de Referencia, Ubicación o Algún Detalle Extra" value="{{old('descripcion')}}">
          </label>
        </div>
