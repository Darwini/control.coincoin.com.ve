    ...
    <div id="main-wrapper">
                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <div class="">
                        <a class="navbar-brand" href="{{url('/user')}}">
                            <b>
                                <img src="{{ asset('assets/images/logo_inicio_tope.png') }}" width="150px" alt="Pagina de Inicio" class="light-logo" />
                            </b>
                        </a>
                    </div>
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li style="padding-top:8px">
                                <h5  style="border-bottom:1px solid; padding-bottom:3px; font-size:12px;" id="_usuario">{{Auth::user()->username }}
                                </h5>
                                <h6 class="text-right">
                ...
                <div class="">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            @if( $ruta != 'changePassword' )
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="{{url('/user')}}" aria-expanded="false"><i class="mdi mdi-home"></i><span class="hide-menu">Inicio</span></a>
                            </li>
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="{{url('mineria')}}" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Minadores</span></a>
                            </li>
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="{{url('ganancias')}}" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Ganancias</span></a>
                            </li>
                            @endif
                        </ul>
                    </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid text-center">
                <b>
                    <img src="{{ asset('assets/images/logo_inicio_footer.png') }}"  alt="Pagina de Inicio" class="light-logo" />
                </b>
            </div>
