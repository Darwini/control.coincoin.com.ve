            ...
            <div style="margin:5px;content:"";display:table;clear:both;width:100%;padding:16px">
                <div style="content:"";display:table;clear:both;width:100%;padding:16px;">
                    <span style="float:left;width:49%">
                        Proveedor : {{$datos->proveedor->nombre}} &nbsp; &nbsp;{{$datos->proveedor->cod_rif}}<br>
                        Fecha : {{$datos->created_at}}
                    </span>
                </div>
            </div>
        
            <div style="display:block;overflow-x:auto; margin-top:10%; margin-bottom:50px;width:99.99999%">
                <table border="0" style="border-collapse:collapse;border-spacing:0;width:100%;display:table;text-align:center;border:1px solid #ccc;font-size:13px!important;">
                    <thead>
